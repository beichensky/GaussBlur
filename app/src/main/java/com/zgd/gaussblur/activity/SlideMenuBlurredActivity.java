 ...
 * 展示侧拉菜单配合高斯模糊的界面
 */
public class SlideMenuBlurredActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_slide_menu_blurred);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.slide_menu_blurred, menu);
        return true;
    }
